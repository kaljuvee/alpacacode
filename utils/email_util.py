...
def send_daily_pnl_report(
    ...
    subject = f"AlpacaCode Daily Report — {date} — P&L: {pnl_sign}${abs(pnl):.2f}"

    body_html = f"""
    <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #333;">AlpacaCode Daily Report</h2>
      ...
      <p style="color:#6c757d; font-size:12px;">
        Generated by AlpacaCode Multi-Agent Trading System
      </p>
    </div>
    """
