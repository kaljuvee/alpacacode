#!/usr/bin/env python3
"""
AlpacaCode Mobile Client — lightweight terminal client for Termux/Android.
Talks to the AlpacaCode API server over HTTPS.
...
DEFAULT_SERVER = "https://api.alpacacode.dev"
...
def main():
    parser = argparse.ArgumentParser(description="AlpacaCode Mobile Client")
    parser.add_argument(
        "--server", "-s",
        default=os.environ.get("ALPACACODE_API", DEFAULT_SERVER),
    ...
    console.print(Panel.fit(
        "[bold cyan]AlpacaCode[/bold cyan]\n"
